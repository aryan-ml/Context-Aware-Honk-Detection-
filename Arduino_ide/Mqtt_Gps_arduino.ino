...
void loop() {
    ...
    if (now - lastPublishTime > publishInterval) {
        ...
        if (gps.location.isValid()) {
            ...
            Serial.println(
                "Telemetry skipped: Waiting for satellite lock coordinates..."
            );
        }
    }
}